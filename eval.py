...
from inference.data.test_datasets import LongTestDataset, DAVISTestDataset, YouTubeVOSTestDataset, AstroTestDataset
...
parser.add_argument('--astro_path', default='../astro')
# For generic (G) evaluation, point to a folder that contains "JPEGImages" and "Annotations"
parser.add_argument('--generic_path')

parser.add_argument('--dataset', help='D16/D17/Y18/Y19/LV1/LV3/A/G', default='D17')
...
is_astro = args.dataset.startswith('A')
...
if is_youtube:
    ...
    meta_dataset = AstroTestDataset(path.join(args.astro_path, 'test-dev'), size=args.size)
